...
import com.mercadinholivre.mercado.service.CategoriaService;
...
public class CategoriaController {
	...
	public ResponseEntity<Categoria> post(@Validated @RequestBody Categoria categoria){
		return ResponseEntity.status(HttpStatus.CREATED).body(service.postCategoria(categoria));
	}
	
	@PutMapping
	public ResponseEntity<Categoria> put(@RequestBody Categoria categoria){
		return ResponseEntity.status(HttpStatus.OK).body(service.postCategoria(categoria));
	}
